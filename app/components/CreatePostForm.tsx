...
export function CreatePostForm() {
  ...
  return (
    <div className="max-w-md mx-auto p-4 bg-white border border-gray-200 rounded-xl shadow-md">
      <h2 className="text-2xl font-bold tracking-tight text-gray-800 mb-4 text-center">Create New Post</h2>
      <Form
        method="post"
        ...
        <div>
          ...
          {previewUrl && (
            <img
              src={previewUrl}
              alt="Image Preview"
              className="mt-4 max-h-72 w-auto rounded-lg shadow-sm ring-1 ring-gray-200 mx-auto"
            />
          )}
